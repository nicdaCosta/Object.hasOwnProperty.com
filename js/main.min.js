...
$hasOwnProperty.history=e?e.split(","):[],$(".results").on("click",".isObject",function(e){var a=$(this),t=a.parent("li")
t.toggleClass("expanded"),e.preventDefault()}),$(".historyPanel").on("click","a",function(e){$hasOwnProperty.search(e,$(this).text())}),$("button.search").on("click",$hasOwnProperty.search),$("#Search").on("keypress",function(e){var a=e.charCode||e.keyCode
13===a&&(e.preventDefault(),$hasOwnProperty.search())}),$(document).on("beginSearch",$hasOwnProperty.updateHistory),$(document).on("endSearch",$hasOwnProperty.populateResults),$(document).on("historyUpdated",$hasOwnProperty.populateHistory)}
